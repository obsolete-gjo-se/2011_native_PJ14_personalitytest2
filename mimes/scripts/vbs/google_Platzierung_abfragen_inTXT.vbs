...
Dim strOutputFile, objFileSystem, objOutputFile, s, Datumstr
Const SUMA = "Google.de (Das Web)"
Const OPEN_FILE_FOR_APPENDING = 8, DATUM = "19.12.2008"
...
sqlout = "SELECT Keyword_Wert.Keywords, Keyword_Wert.PJ02 FROM Keyword_Wert WHERE (((Keyword_Wert.PJ02)=True)) AND (((Keyword_Wert.Keywords)>'appartmen')) ORDER BY Keyword_Wert.Keywords;"
...
'#### in TXT schreiben:
strOutputFile = "E:\Datentransfer\Google\Platzierung\platz3.txt"
...
For num = 1 To 9 
	...
	If iret = 1  Then
		s = iim1.iimGetLastExtract(1) + keyword

...
Const STROUTPUTFILE = "E:\Datentransfer\Google\Platzierung\platz_KW11.txt"
...
sqlout = "SELECT Keyword_Wert.Keyword, Keyword_Wert.PJ02 FROM Keyword_Wert WHERE (((Keyword_Wert.PJ02)=True)) AND (((Keyword_Wert.Keyword)>'a')) ORDER BY Keyword_Wert.Keyword;"

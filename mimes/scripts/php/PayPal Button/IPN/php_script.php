...
$notify_email =  "Benachrichtigungsmail";         //email address to which debug emails are sent to
$DB_Server = "Server"; //your MySQL Server
$DB_Username = "Database-User"; //your MySQL User Name
$DB_Password = "Passwort"; //your MySQL Password
